...
from src.loaders.file_data_loader import FileDataLoader

class TestFileDataLoader(unittest.TestCase):
    def setUp(self):
        self.loader: IPipelineStage = FileDataLoader('data/sample_data.csv')
    ...
    def test_file_load_nonexistent(self):
        ...
        with self.assertRaises(FileNotFoundError):
            loader.execute(PipelineContext(pd.DataFrame()))
